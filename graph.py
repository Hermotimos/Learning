...
# Packages installed via Pycharm/File->Settings->Project:NNNNN
# ->Python Interpreter -> + to add packages
# -> mark option "Install to user's site-packages directory"
...
def hierarchy_pos(
        graph, root=None, width=1., vert_gap=0.2, vert_loc=0, xcenter=0.5):
    '''
    ...
    def _hierarchy_pos(graph, root, width=1., vert_gap=0.2, vert_loc=0,
...
graph_1.add_edges_from([
        ("dsaada",2), ("dsaada",3), ("dsaada",4), (2,5), (2,6), (2,7), (3,8), (3,9), (4,10), (5,11), (5,12), (6,13)
    ])
pos = hierarchy_pos(graph_1, "dsaada")
nx.draw(graph_1, pos=pos, with_labels=True)
